...
**2026-09-14** — Admin mostraba 0 visitas hoy/ayer con total 346: la consulta SQL de `stats.routes.js` restaba un entero a un `timestamp` (inválido), reventaba entera y el `catch` devolvía ceros en silencio. Nunca había funcionado. Skill creada e instalada.
