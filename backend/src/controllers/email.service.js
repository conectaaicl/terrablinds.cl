    ...
    <div style="font-family:Arial,sans-serif;max-width:640px;margin:0 auto;border:1px solid #e5e7eb;border-radius:12px;overflow:hidden;">
        ...
        <div style="padding:28px 32px;">
            ...
            <div style="background:#eff6ff;border-left:4px solid #2563eb;padding:14px 18px;border-radius:0 8px 8px 0;margin-bottom:24px;">
                <p style="margin:0;font-size:13px;color:#1e40af;"><strong>Monto pagado:</strong> $${amount} CLP — Descontable si realizas la instalación con nosotros</p>
            </div>` : `
            <div style="background:#f0fdf4;border-left:4px solid #22c55e;padding:14px 18px;border-radius:0 8px 8px 0;margin-bottom:24px;">
                <p style="margin:0;font-size:13px;color:#166534;"><strong>Sin costo de visita</strong> — Nuestro equipo coordinará contigo los detalles de la instalación.</p>
            </div>`}
