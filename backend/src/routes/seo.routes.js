...
const STATIC_PAGES = {
    ...
    '/cortinas/macul': { title: 'Cortinas Roller en Macul — TerraBlinds', description: 'Cortinas roller, persianas y toldos a medida en Macul. Instalación a domicilio en casas y departamentos de la comuna.', priority: '0.8', changefreq: 'monthly' },
    '/cortinas/la-cisterna': { title: 'Cortinas Roller en La Cisterna — TerraBlinds', description: 'Cortinas roller, persianas y toldos a medida en La Cisterna. Instalación a domicilio en casas, departamentos y locales de la comuna.', priority: '0.8', changefreq: 'monthly' },
    '/cortinas/santiago-centro': { title: 'Cortinas Roller en Santiago Centro — TerraBlinds', description: 'Cortinas roller, persianas y toldos a medida en Santiago Centro. Instalación a domicilio en departamentos, oficinas y locales.', priority: '0.8', changefreq: 'monthly' },
    '/cortinas/estacion-central': { title: 'Cortinas Roller en Estación Central — TerraBlinds', description: 'Cortinas roller, persianas y toldos a medida en Estación Central. Instalación a domicilio en departamentos nuevos y casas.', priority: '0.8', changefreq: 'monthly' },
    '/cortinas/puente-alto': { title: 'Cortinas Roller en Puente Alto — TerraBlinds', description: 'Cortinas roller, persianas y toldos a medida en Puente Alto. Instalación a domicilio en casas, villas y departamentos de la comuna.', priority: '0.8', changefreq: 'monthly' },
    '/automatizacion': {
    ...
    if (productMatch) {
        ...
        if (requestedPath === '/' || requestedPath === '/catalog') {
            ...
            const comunaFaqItems = [
                { "@type": "Question", name: `Hacen visita tecnica en ${nombre}?`, acceptedAnswer: { "@type": "Answer", text: `Si. Un tecnico va a tu domicilio en ${nombre} a tomar las medidas exactas de cada ventana, ${comuna.visitaConCosto ? 'con un costo de traslado que te informamos al cotizar' : 'sin costo y sin compromiso'}.` } },
...
<section style="margin-top:36px;">
    ...
    <ol style="font-size:15px;color:#475569;line-height:2;margin:0;padding-left:22px;">
        ...
        <li>Visita tecnica en tu domicilio (sin costo en la mayoria de las comunas)</li>
...
<section style="margin-top:36px;padding:20px;background:#f0f9ff;border-radius:8px;border-left:4px solid #0d2a5e;">
    ...
    <p style="font-size:15px;color:#475569;margin:0 0 14px;">Visita tecnica sin costo en la mayoria de las comunas de Santiago. Respondemos en menos de 1 hora.</p>
...
<section style="margin-top:36px;padding:20px;background:#f0f9ff;border-radius:8px;border-left:4px solid #0d2a5e;">
    ...
    <p style="font-size:15px;color:#475569;margin:0 0 14px;">Visita tecnica sin costo en la mayoria de las comunas. Respondemos en menos de 1 hora.</p>
    <a href="https://wa.me/56998101891" style="display:inline-block;background:#25D366;color:#fff;padding:12px 24px;border-radius:8px;text-decoration:none;font-weight:700;font-size:15px;">Cotizar por WhatsApp</a>
</section>`;
            jsonLd = [
                { "@context": "https://schema.org", "@type": "LocalBusiness",
