            ...
            >
                <div className="relative z-10 text-center pb-20 sm:pb-24">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 justify-center">
                        <Link to="/catalog" className="px-7 py-3.5 bg-[#C8973A] hover:bg-[#A87A2A] text-white font-semibold rounded-xl transition-all flex items-center justify-center gap-2 shadow-lg">
        ...
        >
            ...
            <div className="relative z-10 h-full flex flex-col items-center justify-end text-center px-4 pb-16 sm:pb-24">
                ...
                <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto px-4 sm:px-0">
                    <Link
                        to="/catalog"
                        className="px-7 py-3.5 bg-[#C8973A] hover:bg-[#A87A2A] text-white font-semibold rounded-xl transition-all flex items-center justify-center gap-2 shadow-lg hover:shadow-[#C8973A]/30 hover:scale-105"
                    >
