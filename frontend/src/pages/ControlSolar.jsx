...
const WA_URL_VISITA = `https://wa.me/${WA_NUMBER}?text=${encodeURIComponent('Hola, quisiera solicitar una visita técnica para evaluar mi espacio.')}`;
...
const FAQS = [
  ...
  { q: '¿Cuánto demora la fabricación e instalación?',
    a: 'La visita técnica es gratuita en la mayoría de las comunas de Santiago (en Colina, Chicureo, Puente Alto, Lo Barnechea y Maipú tiene costo de traslado) y dura 30-60 minutos. La fabricación tarda 5 a 7 días hábiles tras confirmar la cotización. La instalación de cortinas roller es de 1 a 2 horas por ventana; persianas de exterior y toldos pueden tomar una mañana completa.' },
...
const PROCESO = [
  ...
  { n: '02', title: 'Visita técnica', desc: 'Sin costo en la mayoría de las comunas. Medimos y evaluamos tu espacio.' },
      ...
      <section style={{ padding: '56px 24px',
        ...
        <div style={{ maxWidth: '580px', margin: '0 auto' }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.8)', fontSize: '0.95rem', margin: '0 0 28px', lineHeight: 1.7 }}>
            Visita técnica sin costo en la mayoría de las comunas. Fabricamos en Chile. Instalamos en toda la Región Metropolitana.
