...
import { Shield, Clock, Award, PenTool, X, ArrowRight, ExternalLink, Star } from 'lucide-react';
import api from '../api';
                            ...
                            {reviews.map((r, idx) => (
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-3">
                                        {r.avatar_url ? (
                                            <img src={r.avatar_url} alt={r.author_name} className="w-10 h-10 rounded-full object-cover object-center" />
                                        ) : (
