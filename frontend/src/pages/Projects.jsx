        ...
        <Layout>
            ...
            <div className="container mx-auto px-4 py-16">
                ...
                <div className="mt-16 text-center bg-primary-50 border border-primary-100 rounded-2xl p-12">
                    <h2 className="font-display text-2xl font-bold text-gray-900 mb-4">¿Quieres tu proyecto aquí?</h2>
                    <p className="text-gray-600 mb-8">Contáctanos y hacemos realidad tu espacio ideal.</p>
                    <a href="/quote" className="inline-block px-8 py-3 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-xl transition-all hover:scale-105 shadow-sm">
