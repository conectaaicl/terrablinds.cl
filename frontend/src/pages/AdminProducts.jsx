        ...
        <AdminLayout>
            <div className="flex justify-between items-center mb-8">
                ...
                <button onClick={() => handleOpenModal()}
                    className="px-5 py-2.5 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-xl transition-all hover:scale-105 shadow-sm flex items-center gap-2">
