    ...
    return (
        <Layout>
            ...
            <div className="bg-gray-900 py-20 text-center text-white">
                <p className="text-xs font-bold uppercase tracking-widest text-primary-400 mb-3">Colección Completa</p>
                <h1 className="font-display text-4xl md:text-5xl font-bold mb-4">{cfg.catalog_title || 'Catálogo de Productos'}</h1>
            ...
            <div className="container mx-auto px-4 py-12 flex flex-col md:flex-row gap-8">
                ...
                <aside className="w-full md:w-64 flex-shrink-0">
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 sticky top-24">
                        ...
                        <div className="mb-8">
                            <h4 className="text-xs font-bold uppercase tracking-widest text-primary-600 mb-3">Categoría</h4>
                ...
                <div className="flex-1">
                    <div className="flex justify-between items-center mb-6">
                        <p className="text-gray-500 text-sm">Mostrando <span className="font-semibold text-gray-900">{filteredProducts.length}</span> productos</p>
                    </div>
