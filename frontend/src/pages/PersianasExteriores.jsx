...
const PROCESO = [
    ...
    { n: '02', title: 'Visita técnica gratuita', desc: 'Un especialista va a tu domicilio en Santiago a medir, evaluar el espacio y recomendar el sistema.' },
    ...
    { n: '04', title: 'Fabricación en Chile', desc: 'Fabricamos según tus medidas exactas. [DATOS A CONFIRMAR: plazo de fabricación]' },
...
const FAQS = [
    ...
    { q: '¿Las persianas exteriores resisten el viento?', a: '[DATOS A CONFIRMAR: valores específicos de resistencia al viento por modelo]. Los sistemas de exterior están diseñados para soportar viento, especialmente los modelos con guías laterales que mantienen el tejido tensado. En condiciones de viento fuerte, recomendamos recogerlas.' },
    { q: '¿Cuánto dura la instalación de una persiana exterior?', a: '[DATOS A CONFIRMAR: tiempos exactos de instalación]. La instalación típica de una persiana exterior individual toma entre 1 y 2 horas. Proyectos de múltiples unidades se planifican por jornada.' },
    { q: '¿Qué materiales se usan en las persianas de exterior?', a: '[DATOS A CONFIRMAR: especificaciones de materiales, calibres y proveedores]. Los tejidos técnicos para exterior están diseñados para resistir la intemperie, los rayos UV y la humedad. Los mecanismos son en aluminio.' },
    ...
    { q: '¿Cuáles son las medidas máximas disponibles?', a: '[DATOS A CONFIRMAR: dimensiones máximas por modelo]. Fabricamos a medida según las dimensiones de tu espacio. En la visita técnica gratuita medimos y evaluamos la factibilidad según el sistema elegido.' },
    { q: '¿Tienen garantía las persianas exteriores?', a: '[DATOS A CONFIRMAR: términos exactos de garantía]. Todas nuestras instalaciones incluyen garantía en mano de obra. Los mecanismos y tejidos tienen garantía del fabricante. Consulta los detalles al momento de cotizar.' },
    ...
    { q: '¿Cuánto cuestan las persianas exteriores?', a: 'El precio depende del tipo de sistema, las medidas exactas, el material del tejido y si incluye motorización. No publicamos precios estándar porque todo es a medida. Solicita cotización sin compromiso por WhatsApp o agenda una visita técnica gratuita.' },
    ...
    { q: '¿Qué pasa si llueve y la persiana está extendida?', a: '[DATOS A CONFIRMAR: especificaciones técnicas de impermeabilidad por modelo]. Algunos modelos están diseñados para resistir lluvia leve. En lluvia intensa o viento fuerte, recomendamos recoger la persiana. Los modelos motorizados pueden incluir sensores de lluvia y viento opcionales.' },
...
const JSONLD_SCHEMAS = [
    ...
    },
    {
        ...
        description: 'Persianas exteriores a medida para terrazas, balcones y fachadas en Santiago. Control solar, privacidad, motorización y visita técnica gratuita.',
            ...
            <section style={{ background: 'linear-gradient(135deg, #0d2a5e 0%, #1e4080 60%, #2563a8 100%)', color: '#fff', padding: '72px 24px 64px', textAlign: 'center' }}>
                <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} style={{ maxWidth: 760, margin: '0 auto' }}>
                    ...
                    <p style={{ margin: '0 0 36px', fontSize: 'clamp(1rem, 2.5vw, 1.2rem)', opacity: 0.88, lineHeight: 1.7, maxWidth: 600, marginLeft: 'auto', marginRight: 'auto' }}>
                        Control solar real, privacidad en tu terraza y protección para todo el año. Fabricamos e instalamos a medida con visita técnica gratuita.
                    </p>
                ...
                <div style={{ maxWidth: 1100, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 48, alignItems: 'center' }}>
                    <div>
                        ...
                        <ul style={{ margin: '0 0 28px', padding: 0, listStyle: 'none', display: 'flex', flexDirection: 'column', gap: 10 }}>
                            {['Fabricación a medida exacta', 'Tejido técnico resistente a UV e intemperie', 'Marco de aluminio', 'Versión manual o motorizada', 'Colores y opacidades a elección [DATOS A CONFIRMAR]', 'Visita técnica gratuita en Santiago'].map((item, i) => (
                ...
                <div style={{ maxWidth: 900, margin: '0 auto' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 20, margin: '0 0 32px' }}>
                        {[
                            ...
                            { icon: Zap, title: 'Automatización', desc: 'Programa horarios o conecta con sensores de luz y temperatura. [DATOS A CONFIRMAR: modelos de sensores disponibles]' },
                        ].map((item, i) => (
            ...
            <section style={{ background: '#f0f4ff', padding: '56px 24px' }}>
                <div style={{ maxWidth: 700, margin: '0 auto', textAlign: 'center' }}>
                    ...
                    <p style={{ color: '#475569', fontSize: '1rem', lineHeight: 1.75, margin: '0 0 36px' }}>
                        Agenda una visita técnica gratuita en Santiago. Un especialista va a tu domicilio a medir y cotizar sin compromiso.
                    </p>
                    <div style={{ display: 'flex', gap: 14, justifyContent: 'center', flexWrap: 'wrap' }}>
                        <a
                            href={WA_URL_COTIZAR}
            ...
            <section style={{ background: '#0d2a5e', padding: '64px 24px', textAlign: 'center' }}>
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} style={{ maxWidth: 640, margin: '0 auto' }}>
                    ...
                    <p style={{ color: 'rgba(255,255,255,0.75)', fontSize: '1rem', lineHeight: 1.75, margin: '0 0 36px' }}>
                        Respondemos por WhatsApp en menos de 1 hora en horario hábil. Visita técnica gratuita en Santiago.
                    </p>
                    <div style={{ display: 'flex', gap: 14, justifyContent: 'center', flexWrap: 'wrap' }}>
                        <a
                            href={WA_URL_COTIZAR}
