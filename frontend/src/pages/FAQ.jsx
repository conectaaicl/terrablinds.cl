    ...
    return (
        <Layout>
            ...
            <div className="bg-gray-900 py-20 text-center text-white">
                <p className="text-xs font-bold uppercase tracking-widest text-primary-400 mb-3">Soporte</p>
                <h1 className="font-display text-4xl md:text-5xl font-bold mb-4">{cfg.faq_title || 'Preguntas Frecuentes'}</h1>
            ...
            <div className="container mx-auto px-4 py-16 max-w-3xl">
                ...
                <div className="mt-12 text-center bg-primary-50 border border-primary-100 rounded-2xl p-10">
                    <h2 className="font-display text-xl font-bold text-gray-900 mb-2">¿No encontraste tu respuesta?</h2>
                    <p className="text-gray-600 mb-6">Escríbenos por WhatsApp o al formulario de contacto.</p>
                    <a href="/contact" className="inline-block px-8 py-3 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-xl transition-all hover:scale-105 shadow-sm">
                        Contactarnos
                    </a>
                </div>
            </div>
