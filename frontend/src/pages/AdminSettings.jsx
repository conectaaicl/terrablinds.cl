            ...
            {loading ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value={settings.flow_secret_key || ''}
                                    onChange={handleChange}
                                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500"
                            ...
                            <div className="col-span-2">
                                ...
                                <input
                                    type="text"
                                    name="flow_api_url"
                                    value={settings.flow_api_url || 'https://www.flow.cl/api'}
                                    onChange={handleChange}
                                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500"
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            <div>
                                ...
                                <p className="text-xs text-gray-500 mt-1">
                                    Introduce la URL de tu logo. Se actualizará automáticamente en el sitio.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-end">
                        ...
                        >
                            {saving ? <Loader className="w-5 h-5 animate-spin" /> : <Save className="w-5 h-5 mr-2" />}
