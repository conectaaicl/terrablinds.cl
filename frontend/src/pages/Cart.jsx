        ...
        return (
            <Layout>
                ...
                <div className="container mx-auto px-4 py-20 flex flex-col items-center justify-center text-center">
                    ...
                    <h1 className="text-3xl font-bold text-gray-900 mb-4">Cotizacion Enviada</h1>
                    <p className="text-gray-600 max-w-lg mb-8">
                        Hemos recibido tu solicitud. Te enviamos una confirmacion por correo y un ejecutivo te contactara a la brevedad.
                    </p>
                ...
                <div className="container mx-auto px-4">
                    ...
                    {cartItems.length === 0 ? (
                        <div className="bg-white rounded-xl shadow-sm p-12 text-center">
                            <p className="text-gray-500 text-lg mb-6">No tienes productos en tu cotizacion.</p>
                            <Link to="/catalog" className="inline-flex items-center px-6 py-3 bg-primary-600 text-white font-semibold rounded-lg hover:bg-primary-700 transition-colors">
                                Ver Catalogo <ArrowRight className="ml-2 w-5 h-5" />
                            </Link>
                        </div>
                    ) : (
                                ...
                                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 sticky top-24">
                                    ...
                                    <form onSubmit={handleSubmitQuote} className="space-y-4">
                                        ...
                                        <button type="submit" disabled={loading}
                                            className="w-full py-4 bg-primary-600 hover:bg-primary-700 disabled:bg-gray-400 text-white font-bold rounded-lg transition-colors flex justify-center items-center shadow-lg">
                                            {loading ? (
                                                <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-white"></div>
                                            ) : (
                                                <>Solicitar Cotizacion <Send className="w-5 h-5 ml-2" /></>
                                            )}
                                        </button>
