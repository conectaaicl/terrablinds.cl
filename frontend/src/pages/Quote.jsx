            ...
            <Layout>
                ...
                <div className="container mx-auto px-4 py-20 flex flex-col items-center justify-center text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        {waNumber && (
                            <a href={`https://wa.me/${waNumber}?text=${encodeURIComponent(`Hola, acabo de enviar una cotización. Mi nombre es ${userData.name}. ¿Me pueden confirmar el recibo?`)}`}
                                ...
                                {loadingProducts ? (
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="p-4 bg-gray-50 rounded-lg space-y-3">
                                            {/* Color selector */}
                                            {selectedProduct && Array.isArray(selectedProduct.colors) && selectedProduct.colors.length > 0 && (
                                                <div>
                                                    <label className="block text-sm font-medium text-gray-700 mb-1">Color / Tela</label>
                                                    <select className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500"
                                                    ...
                                                    {quoteItems.map(item => (
                                                        <tr key={item.id} className="hover:bg-gray-50">
                                                            ...
                                                            <td className="px-4 py-3 text-sm text-gray-500">
                                                                ...
                                                                {item.color && <span className="ml-1 text-xs text-primary-600">— {item.color}</span>}
                                                            </td>
