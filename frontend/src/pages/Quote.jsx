...
const PRODUCT_TYPES = [
    ...
    { id: 'cierre_terraza',    label: 'Cierre de Terraza',      icon: '🏠', desc: 'Cierre cristal o PVC para terraza',  hasMeasure: true },
...
export default function Quote() {
    ...
    const [userData, setUserData] = useState({ name: '', email: '', phone: '', address: '', commune: '', notes: '' });
    ...
    const handleSendQuote = async (e) => {
        ...
        try {
            const payload = {
                ...
                customer_commune: userData.commune,
            ...
            <div className="bg-gray-50 min-h-screen py-10">
                <div className="container mx-auto px-4 max-w-6xl">
                    ...
                    <div className="text-center mb-8">
                        <h1 className="font-display text-3xl font-bold text-gray-900">Cotizador Express</h1>
                                ...
                                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 sticky top-24">
                                    ...
                                    <form onSubmit={handleSendQuote} className="space-y-3">
                                        {[
                                            ...
                                            { name: 'commune', label: 'Comuna / Ciudad', type: 'text', required: false },
                                        ].map(f => (
                                            <div key={f.name}>
                                        ...
                                        <div>
                                            ...
                                            <textarea rows={2} value={userData.notes} onChange={e => setUserData(p => ({ ...p, notes: e.target.value }))}
                                                placeholder="Comentarios, piso, preferencia horaria..."
