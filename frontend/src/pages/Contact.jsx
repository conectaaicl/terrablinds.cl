        ...
        <Layout>
            ...
            <div className="bg-gray-900 text-white py-20">
                <div className="container mx-auto px-4 text-center">
                    <p className="text-xs font-bold uppercase tracking-widest text-primary-400 mb-3">Estamos aquí</p>
                    <h1 className="font-display text-4xl md:text-5xl font-bold mb-4">Contáctanos</h1>
                        ...
                        {success ? (
                            <div className="h-full flex flex-col items-center justify-center text-center">
                                ...
                                <button
                                    ...
                                    className="mt-8 px-6 py-3 border border-gray-200 hover:border-primary-600 text-gray-700 hover:text-primary-600 font-semibold rounded-xl transition-all"
                                >
                                    Enviar otro mensaje
                                </button>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea name="message" required rows="4" value={formData.message} onChange={handleChange}
                                        className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none transition-all"></textarea>
                                </div>

                                <button type="submit" disabled={loading}
                                    className="w-full py-3 px-6 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-xl transition-all hover:scale-[1.02] shadow-sm flex justify-center items-center gap-2 disabled:opacity-60 disabled:hover:scale-100">
                                    {loading ? (
