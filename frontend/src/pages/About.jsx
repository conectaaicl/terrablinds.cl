        ...
        <Layout>
            ...
            <div className="bg-gray-900 py-20 text-center text-white">
                <div className="container mx-auto px-4">
                    <p className="text-xs font-bold uppercase tracking-widest text-primary-400 mb-3">Nuestra Empresa</p>
                    <h1 className="font-display text-4xl md:text-5xl font-bold mb-4">{cfg.about_title}</h1>
                    <p className="text-lg text-gray-400 max-w-2xl mx-auto">{cfg.about_subtitle}</p>
                </div>
            </div>
            ...
            <div className="container mx-auto px-4 py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div>
                        ...
                        <h2 className="font-display text-3xl font-bold text-gray-900 mt-2 mb-6">{cfg.about_history_title}</h2>
